...
const texts = {
  ...
  sendEmotion: { ru: "Отправить эмоцию", en: "Send emotion" },
  inbox: { ru: "Входящие", en: "Inbox" },
  noMessages: { ru: "Сообщений пока нет", en: "No messages yet" },
  messageFrom: { ru: "от", en: "from" },
  selectEmotion: { ru: "Выберите эмоцию", en: "Select emotion" },
  sendBtn: { ru: "Отправить", en: "Send" },
  messageSent: { ru: "Отправлено!", en: "Sent!" },
  unread: { ru: "непрочитанных", en: "unread" },
  collections: { ru: "Коллекции", en: "Collections" },
  newCollection: { ru: "Новая коллекция", en: "New collection" },
  collectionTitle: { ru: "Название коллекции", en: "Collection title" },
  addToCollection: { ru: "В коллекцию", en: "Add to collection" },
  addedToCollection: { ru: "Добавлено!", en: "Added!" },
  noCollections: { ru: "Коллекций пока нет", en: "No collections yet" },
  createAndAdd: { ru: "Создать и добавить", en: "Create & add" },
